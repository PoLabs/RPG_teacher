...
packages = [
    "aiohappyeyeballs==2.4.0", "aiohttp==3.10.5", "aiosignal==1.3.1", "altair==5.4.1",
    "annotated-types==0.7.0", "anyio==4.6.0", "argon2-cffi==23.1.0", "argon2-cffi-bindings==21.2.0",
    "arrow==1.3.0", "asttokens==2.4.1", "async-lru==2.0.4", "async-timeout==4.0.3",
    "attrs==24.2.0", "babel==2.16.0", "beautifulsoup4==4.12.3", "bleach==6.1.0",
    "blinker==1.8.2", "cachetools==5.5.0", "certifi==2024.8.30", "cffi==1.17.1",
    "charset-normalizer==3.3.2", "click==8.1.7", "comm==0.2.2", "dataclasses-json==0.6.7",
    "debugpy==1.8.5", "decorator==5.1.1", "defusedxml==0.7.1", "Deprecated==1.2.14",
    "dirtyjson==1.0.8", "distro==1.9.0", "exceptiongroup==1.2.2", "executing==2.1.0",
    "fastjsonschema==2.20.0", "filelock==3.16.1", "fqdn==1.5.1", "frozenlist==1.4.1",
    "fsspec==2024.9.0", "gitdb==4.0.11", "GitPython==3.1.43", "greenlet==3.1.1",
    "h11==0.14.0", "httpcore==1.0.5", "httpx==0.27.2", "huggingface-hub==0.25.0",
    "idna==3.10", "ipykernel==6.29.5", "ipython==8.27.0", "ipywidgets==8.1.3",
    "isoduration==20.11.0", "jedi==0.19.1", "Jinja2==3.1.4", "jiter==0.5.0",
    "joblib==1.4.2", "json5==0.9.25", "jsonpointer==3.0.0", "jsonschema==4.23.0",
    "jsonschema-specifications==2023.12.1", "jupyter==1.1.1", "jupyter-console==6.6.3",
    "jupyter-events==0.10.0", "jupyter-lsp==2.2.5", "jupyter_client==8.6.3",
    "jupyter_core==5.7.2", "jupyter_server==2.14.2", "jupyter_server_terminals==0.5.3",
    "jupyterlab==4.2.5", "jupyterlab_pygments==0.3.0", "jupyterlab_server==2.27.3",
    "jupyterlab_widgets==3.0.13", "llama-cloud==0.0.6", "llama-index==0.11.14",
    ...
    "llama-index-readers-llama-parse==0.3.0", "llama-parse==0.5.6", "markdown-it-py==3.0.0",
    "MarkupSafe==2.1.5", "marshmallow==3.22.0", "matplotlib-inline==0.1.7", "mdurl==0.1.2",
    "mistune==3.0.2", "multidict==6.1.0", "mypy-extensions==1.0.0", "narwhals==1.8.2",
    "nbclient==0.10.0", "nbconvert==7.16.4", "nbformat==5.10.4", "nest-asyncio==1.6.0",
    "networkx==3.3", "nltk==3.9.1", "notebook==7.2.2", "notebook_shim==0.2.4",
    "numpy==1.26.4", "nvidia-ml-py3==7.352.0", "openai==1.47.0", "overrides==7.7.0",
    "packaging==24.1", "pandas==2.2.3", "pandocfilters==1.5.1", "parso==0.8.4",
    "pexpect==4.9.0", "pillow==10.4.0", "pinecone==5.3.1", "pinecone-plugin-inference==1.1.0",
    "pinecone-plugin-interface==0.0.7", "platformdirs==4.3.6", "prometheus_client==0.21.0",
    "prompt_toolkit==3.0.47", "protobuf==5.28.2", "psutil==6.0.0", "ptyprocess==0.7.0",
    "pure_eval==0.2.3", "pyarrow==17.0.0", "pycparser==2.22", "pydantic==2.9.2",
    "pydantic_core==2.23.4", "pydeck==0.9.1", "Pygments==2.18.0", "pypdf==4.3.1",
    "python-dateutil==2.9.0.post0", "python-json-logger==2.0.7", "pytz==2024.2",
    "PyYAML==6.0.2", "pyzmq==26.2.0", "referencing==0.35.1", "regex==2024.9.11",
    "requests==2.32.3", "rfc3339-validator==0.1.4", "rfc3986-validator==0.1.1",
    "rich==13.8.1", "rpds-py==0.20.0", "safetensors==0.4.5", "Send2Trash==1.8.3",
    "six==1.16.0", "smmap==5.0.1", "sniffio==1.3.1", "soupsieve==2.6", "SQLAlchemy==2.0.35",
    "stack-data==0.6.3", "streamlit==1.38.0", "striprtf==0.0.26", "tenacity==8.5.0",
    "terminado==0.18.1", "tiktoken==0.7.0", "tinycss2==1.3.0", "tokenizers==0.19.1",
    "toml==0.10.2", "tomli==2.0.1", "tornado==6.4.1", "tqdm==4.66.5", "traitlets==5.14.3",
    "transformers==4.44.2", "types-python-dateutil==2.9.0.20240906", "typing-inspect==0.9.0",
    "typing_extensions==4.12.2", "tzdata==2024.1", "uri-template==1.3.0", "urllib3==2.2.3",
    "watchdog==4.0.2", "wcwidth==0.2.13", "webcolors==24.8.0", "webencodings==0.5.1",
    "websocket-client==1.8.0", "widgetsnbextension==4.0.13", "wrapt==1.16.0", "yarl==1.11.1"
]
